...
export async function generateMetadata({
  ...
  const currentUrl = `${baseUrl}/${locale}/services/ai-training`;

  return {
    title: 'AI Training - Expand Matrix',
    description: 'Prepare your team for the future with our comprehensive AI training and certification programs.',
    alternates: {
