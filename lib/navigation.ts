...
export function getLocalizedNavigation(lang: 'cs' | 'en'): NavigationItem[] {
  return [
      ...
      submenu: [
        {
          ...
          href: `/${lang}/${lang === 'cs' ? 'sluzby/ai-systemy-na-miru' : 'services/custom-ai-systems'}` as Route,
        },
        {
          name: lang === 'cs' ? 'AI Balíčky' : 'AI Packages',
          href: `/${lang}/${lang === 'cs' ? 'sluzby/ai-balicky' : 'services/ai-packages'}` as Route,
        },
        {
          name: lang === 'cs' ? 'AI Školení' : 'AI Training',
          href: `/${lang}/${lang === 'cs' ? 'sluzby/ai-skoleni' : 'services/ai-training'}` as Route,
        },
      ],
    },
    {
    ...
    {
      name: lang === 'cs' ? 'Portfolio' : 'Portfolio',
